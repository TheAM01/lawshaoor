...
const EXPERTISE = [
  {
    ...
    blurb: 'Buy-side, sell-side, carve-outs, roll-ups. Strategy through close — and the integration that actually matters.',
  ...
  },
  {
    ...
    blurb: 'Boards, bylaws, committees, compliance. The unsexy architecture that decides who decides what — and when.',
...
export default function Home() {
  ...
  useGSAP(() => {
    ...
    const words = ['mergers.', 'boards.', 'capital.', 'deals.', 'exits.']
  ...
  return (
    <main className="relative overflow-hidden">
      ...
      {/* ────────────────────────────────────────────
          01 · HERO — fixed mist bg, 2-line max
          ──────────────────────────────────────────── */}
      ...
      <div className="bg-fixed-lavender">
        <PinnedWords
          words={[
            ...
            'The deal closes. We stay on the call. That is where the work actually lives.',
          ]}
        />
      </div>

      {/* ────────────────────────────────────────────
          03 · STATS — fixed bg deep
          ──────────────────────────────────────────── */}
      ...
      {/* ────────────────────────────────────────────
          04 · EXPERTISE — fixed bg lavender
          ──────────────────────────────────────────── */}
          ...
          <div className="grid grid-cols-12 gap-6 mb-16 md:mb-24">
            ...
            <div className="col-span-12 md:col-span-9">
              <h2 className="display-lg font-display">
                ...
                <span className="block text-gradient"><SplitReveal>actually do.</SplitReveal></span>
              </h2>
            </div>
          </div>
      ...
      {/* ────────────────────────────────────────────
          06b · FEATURED MATTERS
          ──────────────────────────────────────────── */}
      <section className="relative section-pad py-24 md:py-36 border-t border-foreground/15 bg-background">
        <div className="max-w-[1440px] mx-auto relative">
          <div className="grid grid-cols-12 gap-6 mb-12 md:mb-16 items-end">
            <div className="col-span-12 md:col-span-5 space-y-4">
              ...
              <h2 className="display-md font-display">
                ...
                <span className="text-gradient"><SplitReveal>on the desk lately.</SplitReveal></span>
              </h2>
            </div>
            <div className="col-span-12 md:col-span-5 md:col-start-8">
              <FadeIn>
                <p className="text-foreground/80 leading-relaxed font-heading tracking-[-0.005em]">
                  A short slice of what we have been working through. Some are public. Most are not — names off, shape on.
                </p>
              </FadeIn>
            </div>
          </div>
          ...
          <FadeIn staggerChildren className="grid grid-cols-1">
            <div className="hidden md:grid grid-cols-12 gap-6 py-4 border-b border-foreground/20 text-foreground/55 eyebrow-sm">
            ...
            {FEATURED_MATTERS.map((m) => (
              <div
                key={m.code}
                className="group grid grid-cols-2 md:grid-cols-12 gap-3 md:gap-6 py-5 md:py-6 border-b border-foreground/15 items-baseline hover:bg-background-alt transition-colors duration-300 cursor-default"
              >
                <span className="md:col-span-1 eyebrow text-primary font-medium">{m.code}</span>
                <span className="md:col-span-1 text-sm text-foreground/60 tabular-fig font-mono">{m.y}</span>
                <span className="col-span-2 md:col-span-6 font-display text-xl md:text-2xl tracking-[-0.015em] text-foreground group-hover:text-primary transition-colors">{m.t}</span>
                <span className="md:col-span-2 text-sm text-foreground/80 tabular-fig font-mono">{m.v}</span>
      ...
      {/* ────────────────────────────────────────────
          07 · TESTIMONIALS — fixed lavender
          ──────────────────────────────────────────── */}
        ...
        <div className="max-w-[1440px] mx-auto relative">
          <div className="grid grid-cols-12 gap-6 mb-12 md:mb-16 items-end">
            <div className="col-span-12 md:col-span-6 space-y-4">
              ...
              <h2 className="display-md font-display">
                ...
                <span className="text-gradient"><SplitReveal>actually say.</SplitReveal></span>
              </h2>
            </div>
            <div className="col-span-12 md:col-span-4 md:col-start-9">
              <FadeIn>
                <p className="text-foreground/80 leading-relaxed font-heading tracking-[-0.005em]">
                  Real founders, real GCs, real partners — quoted with permission. No anonymous testimonials, no &ldquo;Fortune 500 executive&rdquo; filler.
                </p>
              </FadeIn>
            </div>
          </div>
          ...
          <FadeIn staggerChildren className="grid grid-cols-1 md:grid-cols-2 gap-px bg-foreground/15">
            {TESTIMONIALS.map((t, i) => (
              <article
                key={i}
                className="bg-background p-8 md:p-10 lift-card relative"
              >
                <span aria-hidden className="absolute top-4 right-6 font-display text-primary/40 text-6xl leading-none select-none">&ldquo;</span>
                <p className="font-display text-2xl md:text-3xl leading-[1.15] tracking-[-0.02em] text-foreground mb-8">
                  {t.quote}
                </p>
                <div className="flex items-center gap-4 pt-6 border-t border-foreground/15">
                  <span className="w-10 h-10 border border-primary/50 bg-primary/10 flex items-center justify-center font-display text-primary text-base">
                    {t.name.split(' ').map((n) => n[0]).join('')}
                  </span>
                  <div className="flex-1 min-w-0">
                    <p className="font-medium text-foreground truncate font-heading tracking-[-0.005em]">{t.name}</p>
                    <p className="text-xs text-foreground/65 truncate font-mono tracking-[0.16em] uppercase">{t.role}</p>
                  </div>
          ...
          <div className="grid grid-cols-12 gap-6 items-end">
            <div className="col-span-12 md:col-span-8 space-y-6">
              ...
              <h2 className="display-lg font-display">
                ...
                <span className="block text-gradient"><SplitReveal>We bring the law.</SplitReveal></span>
              </h2>
            </div>
...
/* ────────────────────────────────────────────
   Process timeline — vertical line draws on scroll
   ──────────────────────────────────────────── */
